// 2018年9月16日移植klayGE @zhangbei
#ifndef STX_INPUT_HPP
#define STX_INPUT_HPP
#pragma once
...
typedef boost::signals2::signal<void(const InputEngine& sender, const InputAction& action)> input_signal;
...
// 输入引擎
/////////////////////////////////////////////////////////////////////////////////
class InputEngine : public IEntityEx
{
public:
...
public:
	STX_ENTITY(InputEngine, IEntityEx);
	...
	virtual bool OnShut() override { return true; }
...
class InputTouch : public InputDevice
{
public:
	InputTouch();
	virtual ~InputTouch();
...
class InputSensor : public InputDevice
{
public:
	InputSensor();
	virtual ~InputSensor();
...
struct InputKeyboardActionParam : public InputActionParam
{
...
struct InputMouseActionParam : public InputActionParam
{
	int2 move_vec;
	int32_t wheel_delta;
	int2 abs_coord;
...
struct InputJoystickActionParam : public InputActionParam
{
	int3 pos;
	int3 rot;
	int2 slider;
...
struct InputTouchActionParam : public InputActionParam
{
...
struct InputSensorActionParam : public InputActionParam
{
	float latitude;
	float longitude;
	float altitude;
