...
#ifndef _STX_ELEMENTFORMAT_H_
#define _STX_ELEMENTFORMAT_H_
#pragma once
...
inline uint32_t ComponentBpps(ElementFormat format)
{
	//避免与Windows.h中的min、max宏定义冲突
