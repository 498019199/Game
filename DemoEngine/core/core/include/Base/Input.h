...
namespace RenderWorker
{
	...
	struct ZENGINE_CORE_API InputActionDefine
	{
	...
	// 输入动作格式
	/////////////////////////////////////////////////////////////////////////////////
	class ZENGINE_CORE_API InputActionMap final
	{
	public:
	...
	// 输入引擎
	/////////////////////////////////////////////////////////////////////////////////
	class ZENGINE_CORE_API InputEngine
	{
		ZENGINE_NONCOPYABLE(InputEngine);
	...
	class ZENGINE_CORE_API InputDevice
	{
		ZENGINE_NONCOPYABLE(InputDevice);
	...
	class ZENGINE_CORE_API InputKeyboard : public InputDevice
	{
	public:
		InputKeyboard();
	...
	class ZENGINE_CORE_API InputMouse : public InputDevice
	{
	public:
		InputMouse();
		virtual ~InputMouse();
	...
	class ZENGINE_CORE_API InputJoystick : public InputDevice
	{
	public:
		InputJoystick();
	...
	class ZENGINE_CORE_API InputTouch : public InputDevice
	{
	public:
		InputTouch();
		virtual ~InputTouch();
	...
	class ZENGINE_CORE_API InputSensor : public InputDevice
	{
	public:
		InputSensor();
		virtual ~InputSensor();
		...
		quater const & OrientationQuat() const;
	...
	struct ZENGINE_CORE_API InputActionParam
	{
		InputActionParam();
	...
	struct ZENGINE_CORE_API InputKeyboardActionParam final : public InputActionParam
	{
	...
	struct ZENGINE_CORE_API InputMouseActionParam final : public InputActionParam
	{
		int2 move_vec;
		int32_t wheel_delta;
		int2 abs_coord;
	...
	struct ZENGINE_CORE_API InputJoystickActionParam final : public InputActionParam
	{
		float3 thumbs[2];
		float triggers[2];
	...
	struct ZENGINE_CORE_API InputTouchActionParam final : public InputActionParam
	{
	...
	struct ZENGINE_CORE_API InputSensorActionParam final : public InputActionParam
	{
		float latitude;
		float longitude;
		float altitude;
