...
{
	class ZENGINE_CORE_API Query
	{
		ZENGINE_NONCOPYABLE(Query);
	...
	class ZENGINE_CORE_API OcclusionQuery : public Query
	{
	public:
	...
	class ZENGINE_CORE_API ConditionalRender : public Query
	{
	public:
	...
	class ZENGINE_CORE_API TimerQuery : public Query
	{
	public:
	...
	class ZENGINE_CORE_API SOStatisticsQuery : public Query
	{
	public:
