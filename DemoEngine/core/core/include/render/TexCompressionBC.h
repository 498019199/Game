...
namespace RenderWorker
{
	...
	class ZENGINE_CORE_API TexCompressionBC1 final : public TexCompression
	{
	public:
		TexCompressionBC1();
	...
	class ZENGINE_CORE_API TexCompressionBC2 final : public TexCompression
	{
	public:
		TexCompressionBC2();
	...
	class ZENGINE_CORE_API TexCompressionBC4 final : public TexCompression
	{
	public:
		TexCompressionBC4();
	...
	class ZENGINE_CORE_API TexCompressionBC3 final : public TexCompression
	{
	public:
		TexCompressionBC3();
	...
	class ZENGINE_CORE_API TexCompressionBC5 final : public TexCompression
	{
	public:
		TexCompressionBC5();
	...
	class ZENGINE_CORE_API TexCompressionBC6U final : public TexCompression
	{
	public:
		TexCompressionBC6U();
	...
	class ZENGINE_CORE_API TexCompressionBC6S final : public TexCompression
	{
	public:
		TexCompressionBC6S();
	...
	class ZENGINE_CORE_API TexCompressionBC7 final : public TexCompression
	{
	...
	ZENGINE_CORE_API void BC4ToBC1G(BC1Block& bc1, BC4Block const & bc4);
}
