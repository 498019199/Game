...
#elif defined(ZENGINE_PLATFORM_WINDOWS_STORE) || defined(ZENGINE_PLATFORM_ANDROID) || defined(ZENGINE_PLATFORM_DARWIN)
...
#if defined ZENGINE_PLATFORM_WINDOWS_DESKTOP
#if defined DZENGINE__HAVE_LIBOVR
		OVR::System::Destroy();
#endif
...
#if ((defined ZENGINE_PLATFORM_WINDOWS_DESKTOP) && (_WIN32_WINNT >= _WIN32_WINNT_WINBLUE)) \
			|| defined(ZENGINE_PLATFORM_WINDOWS_STORE) || defined(ZENGINE_PLATFORM_ANDROID) || defined(ZENGINE_PLATFORM_DARWIN)
...
#if (defined ZENGINE_PLATFORM_WINDOWS_DESKTOP) && (defined DZENGINE__HAVE_LIBOVR)
		OVR::System::Init(OVR::Log::ConfigureDefaultLog(OVR::LogMask_All));
		devices_.push_back(MakeSharedPtr<MsgInputOVR>());
#endif

#if defined(ZENGINE_PLATFORM_WINDOWS) || defined(ZENGINE_PLATFORM_ANDROID)
