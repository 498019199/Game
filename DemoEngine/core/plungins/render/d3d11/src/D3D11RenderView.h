...
{
public:
    D3D11Texture1D2DCubeRenderTargetView(TexturePtr const & texture_1d_2d_cube, 
...
{
public:
    D3D11Texture3DRenderTargetView(TexturePtr const & texture_3d, ElementFormat pf, 
...
{
public:
    D3D11TextureCubeFaceRenderTargetView(TexturePtr const & texture_cube, ElementFormat pf, 
...
{
public:
    D3D11BufferRenderTargetView(GraphicsBufferPtr const & gb, ElementFormat pf, 
