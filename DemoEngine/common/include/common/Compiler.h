#pragma once
	...
	#if defined(_MSC_VER)
		#define DEMOENGINE_COMPILER_CLANGCL
		#define DEMOENGINE_COMPILER_NAME clangcl

		#if CLANG_VERSION >= 120
			#define DEMOENGINE_COMPILER_VERSION CLANG_VERSION
		#else
			#error "Unsupported compiler version. Please install clang-cl 12.0 or up."
		#endif
	#else
		#define DEMOENGINE_COMPILER_CLANG
		#define DEMOENGINE_COMPILER_NAME clang
	...
	#define DEMOENGINE_COMPILER_MSVC
	#define DEMOENGINE_COMPILER_NAME vc
    ...
    #define DEMOENGINE_COMPILER_GCC
	#if defined(_WIN32) || defined(__WIN32__) || defined(WIN32)
		#define DEMOENGINE_COMPILER_NAME mgw
	#else
		#define DEMOENGINE_COMPILER_NAME gcc
	#endif

    #define GCC_VERSION KFL_JOIN(__GNUC__, __GNUC_MINOR__)
	#if GCC_VERSION >= 110
		#define DEMOENGINE_COMPILER_VERSION GCC_VERSION
	#else
