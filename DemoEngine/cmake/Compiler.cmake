...
if(MSVC)
    ...
    ENDFOREACH()
    # Clang on case-insensitive APFS still errors on include-path case under -Werror.
    IF(ZENGINE_COMPILER_CLANG)
        FOREACH(flag_var
            CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
            SET(${flag_var} "${${flag_var}} -Wno-error=nonportable-include-path -Wno-nonportable-include-path -Wno-error=unused-parameter -Wno-error=deprecated-literal-operator -Wno-error=unused-variable -Wno-error=unnecessary-virtual-specifier -Wno-error=reorder-ctor -Wno-error=unused-but-set-variable -Wno-error=inconsistent-missing-override -Wno-error=unused-function")
        ENDFOREACH()
    ENDIF()
    ...
    # -m32/-m64 are x86-specific; skip on Apple Silicon / ARM and let the toolchain pick the arch.
    IF(NOT (ZENGINE_PLATFORM_DARWIN OR ZENGINE_PLATFORM_IOS OR (ZENGINE_ARCH_NAME MATCHES "arm")))
